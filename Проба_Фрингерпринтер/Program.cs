...
namespace Mfccextractor
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Добро пожаловать в программу на основе метода MFCC!");
            string originalAudioPath = @"C:\Users\Повелитель\source\repos\Проба_Фрингерпринтер\Проба_Фрингерпринтер\FilesAudio\TestAudio.wav";
            string editedAudioPath = @"C:\Users\Повелитель\source\repos\Проба_Фрингерпринтер\Проба_Фрингерпринтер\FilesAudio\TestAudioEdit.wav";

            ProcessAudio(originalAudioPath, editedAudioPath);
